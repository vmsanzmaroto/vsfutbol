...
export const products: Product[] = [
  ...
  },
  {
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Laliga", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/malaga.jpg", "/products/malaga1.jpg", "/products/malaga6.jpg"],
  },
      {
      slug: "Malaga1",
	  team: "Malaga",
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Laliga", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/tenerife.jpg", "/products/tenerife1.jpg", "/products/tenerife2.jpg"],
  },
    {
      slug: "Granada",
	  team: "Granada",
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Laliga", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/granada.jpg", "/products/granada1.jpg", "/products/granada2.jpg"],
  },
      {
      slug: "Reavalladolid",
	  team: "Real Valladolid",
    title: "Real Valladolid 25/26",
    price: "20€",
    description:
      "Camiseta de alta calidad con tejido transpirable y excelente acabado. Ideal para partido o uso diario.",
    sizes: ["S", "M", "L", "XL"],
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Laliga", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/valladolid.jpg", "/products/valladolid1.jpg", "/products/valladolid8.jpg"],
  },
        {
      slug: "Reavalladolid1",
	  team: "Real Valladolid",
    title: "Real Valladolid 95/96",
    price: "26€",
    description:
      "Camiseta de alta calidad con tejido transpirable y excelente acabado. Ideal para partido o uso diario.",
    sizes: ["S", "M", "L", "XL"],
  ...
  },
   {
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Selecciones", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/alemania.jpg", "/products/alemania1.jpg"],
  },
           {
      slug: "Alemania1",
	  team: "Alemania",
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Selecciones", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/alemania2.jpg", "/products/alemania3.jpg"],
  },
  {
      slug: "Colombia",
	  team: "Colombia",
    title: "Colombia 25/26",
    price: "20€",
    description:
      "Camiseta de alta calidad con tejido transpirable y excelente acabado. Ideal para partido o uso diario.",
    sizes: ["S", "M", "L", "XL"],
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Selecciones", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/colombia.jpg", "/products/colombia1.jpg"],
  },
    {
      slug: "Colombia1",
	  team: "Colombia",
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Selecciones", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/colombia2.jpg", "/products/colombia3.jpg"],
  },
      {
      slug: "Belgica",
	  team: "Belgica",
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Selecciones", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/belgica.jpg", "/products/belgica1.jpg"],
  },
        {
      slug: "Belgica1",
	  team: "Belgica",
    ...
    inStockSizes: ["S", "M", "L", "XL"],
    badges: [{ label: "Selecciones", style: "from-blue-600 to-fuchsia-600" }],
    images: ["/products/belgica2.jpg", "/products/belgica3.jpg"],
  },
];
